...
public class UtilProp {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/cdandjrphillips/git/Bloghost/BlogHost/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/techExercise_Phillips/config.properties";
