...
final public class BlogHostCreators extends Model
{
	...
	@Column(columnName="user_name", methodName="setUserName", methodParameter=String.class)
	private String user_name;
	
	@Column(columnName="first_name", methodName="setFirstName", methodParameter=String.class)
	private String first_name;
	
	@Column(columnName="last_name", methodName="setLastName", methodParameter=String.class)
	private String last_name;
	
	@Column(columnName="email", methodName="setEmail", methodParameter=String.class)
	private String email;
	
	@Column(columnName="age", methodName="setAge", methodParameter=Integer.class)
	private Integer age;
	
	@Column(columnName="password", methodName="setPassword", methodParameter=String.class)
