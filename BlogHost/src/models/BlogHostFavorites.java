...
public final class BlogHostFavorites extends Model
{
	...
	static
	{
		...
		try
		{
			columnParameters.put("reader_id", BlogHostFavorites.class.getMethod("setReaderID", Integer.class));
			columnParameters.put("post_id", BlogHostFavorites.class.getMethod("setPostID", BigInteger.class));
		}
