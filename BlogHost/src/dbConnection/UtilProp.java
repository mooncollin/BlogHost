...
public class UtilProp {
   ...
   // * Local server path
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\user\\eclipse-workspace1\\TechEx_Zhuromski\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/TechEx_Zhuromski/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/BlogHost/config.properties";
